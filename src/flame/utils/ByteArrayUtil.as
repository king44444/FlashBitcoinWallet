...
package flame.utils
{
	...
	public final class ByteArrayUtil
	{
		 ...
		 * @throws ArgumentError <code>byteArray</code> parameter is <code>null</code>.
		 */
		public static function toVector(byteArray:ByteArray):Vector.<uint>
		{
		...
		public static function tByteArrayFromAry(ary:Array):ByteArray
		{
			
			var byteArray:ByteArray = new ByteArray();
			
			for (var i:int = 0, count:int = ary.length; i < count; i++)
				byteArray.writeByte(ary[i]);
